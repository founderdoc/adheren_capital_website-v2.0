...
/* ------------------------------------- */
    ...
    $('a.team-content').click(function(){
        $("#mcs_container").mCustomScrollbar("scrollTo", "#team-content",{
            scrollInertia:500,
            callbacks:false
        });
    });

    $('a.criteria-content').click(function(){
        $("#mcs_container").mCustomScrollbar("scrollTo", "#criteria-content",{
            scrollInertia:500,
            callbacks:false
        });
    });
